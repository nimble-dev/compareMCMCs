...
#> 1 nimble       272711.2        272711.2
#> 
#> $byParameter
#>     MCMC Parameter     mean   median       sd CI95_low CI95_upp      ESS
#> 1 nimble         a 5.024547 4.725302 2.012188 1.704897  9.65107 818.1337
#>   efficiency
#> 1   272711.2
#> 
#> $other
...
#> 1 nimble       272711.2        272711.2         2.44791
#> 
#> $byParameter
#>     MCMC Parameter     mean   median       sd CI95_low CI95_upp      ESS
#> 1 nimble         a 5.024547 4.725302 2.012188 1.704897  9.65107 818.1337
#>   efficiency      p25      p75
#> 1   272711.2 3.694202 6.142112
#> 
#> $other
#> list()
```
...
#> 1         jags     log_a 1.525154 1.574682 0.4460515 0.5144139 2.234667
#> 2       nimble     log_a 1.506104 1.552619 0.4402313 0.5208743 2.200393
#> 3 nimble_slice     log_a 1.523469 1.597308 0.4624378 0.3867174 2.231395
#>         ESS efficiency
#> 1 1242.8499   112986.4
#> 2  438.5948   438594.8
#> 3 1900.0000   475000.0
#> 
#> $byMCMC
#>           MCMC min_efficiency mean_efficiency
#> 1         jags       112986.4        112986.4
#> 2       nimble       438594.8        438594.8
#> 3 nimble_slice       475000.0        475000.0
```
...
#>     samples: 5.11914352478718 4.59166700986035 4.49223799722782 1.967 ...
...
#>     metrics: list
#>     rename: function (newName, oldName) 
#>     samples: 5.60010966082851 5.60010966082851 5.25478000597844 7.002 ...
#>     sessionInfo: sessionInfo
#>     setSamples: function (samples) 
#>     times: list
#> 
...
#>     metrics: list
#>     rename: function (newName, oldName) 
#>     samples: 4.34136621026928 5.06519566198486 5.90733233049187 3.117 ...
#>     sessionInfo: sessionInfo
#>     setSamples: function (samples) 
#>     times: list
clearMetrics(res)
...
#> $byParameter
#>           MCMC Parameter     mean   median       sd CI95_low CI95_upp       ESS
#> 1         jags         a 5.017371 4.829206 1.984103 1.672658 9.343369  985.7875
#> 2       nimble         a 4.928662 4.723824 1.975328 1.683510 9.028620  415.0431
#> 3 nimble_slice         a 5.030552 4.939717 1.992757 1.472141 9.312853 1705.7418
#>   efficiency
#> 1   89617.04
#> 2  415043.12
#> 3  426435.45
...
#> $byMCMC
#>           MCMC min_efficiency mean_efficiency
#> 1         jags       89617.04        89617.04
#> 2       nimble      415043.12       415043.12
#> 3 nimble_slice      426435.45       426435.45
```
