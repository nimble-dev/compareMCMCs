...
**MCMC efficiency** for a parameter is defined as the effective sample size divided by computation time (in seconds).  This is the number of effectively independent samples generated per second.  **MCMC pace** is defined as the inverse of MCMC efficiency.  This is the seconds per effectively independent sample.
