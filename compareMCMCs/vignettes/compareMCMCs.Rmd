...
Beware that you might need to call the `compareMCMCs` function as `compareMCMCs::compareMCMCs`.  That's because there is a deprecated `compareMCMCs` function in `nimble`.  Eventually that will be removed from `nimble`. `compareMCMCs` is not backward-compatible with `nimble`'s original features for comparing MCMC methods.
...
# browseURL(file.path(work_dir, "example1.html"))   
```

Results (run on one of the author's machines) are [here](example1.html).  In this case, all samplers are so efficient that the comparison between them is not very stable and not meaningful for such a toy model.
...
make_MCMC_comparison_pages(res, dir = work_dir, modelName = 'example2')
```

Results are [here](example2.html). 
...
#> 1 nimble       387675.5        387675.5
#> 
#> $byParameter
#>     MCMC Parameter     mean   median      sd CI95_low CI95_upp     ESS
#> 1 nimble         a 5.060889 4.899542 2.12018 1.442981 9.586273 775.351
#>   efficiency
#> 1   387675.5
#> 
#> $other
...
#> 1 nimble       387675.5        387675.5        2.940265
#> 
#> $byParameter
#>     MCMC Parameter     mean   median      sd CI95_low CI95_upp     ESS
#> 1 nimble         a 5.060889 4.899542 2.12018 1.442981 9.586273 775.351
#>   efficiency      p25      p75
#> 1   387675.5 3.486944 6.427208
#> 
#> $other
#> list()
```
...
#> 1         jags     log_a 1.524983 1.577903 0.4450360 0.4927061 2.245681
#> 2       nimble     log_a 1.527910 1.576066 0.4438445 0.5165181 2.235235
#> 3 nimble_slice     log_a 1.508288 1.578324 0.4690385 0.4303539 2.235334
#>         ESS efficiency
#> 1 1081.1740   108117.4
#> 2  464.5451   464545.1
#> 3 2171.9133   542978.3
#> 
#> $byMCMC
#>           MCMC min_efficiency mean_efficiency
#> 1         jags       108117.4        108117.4
#> 2       nimble       464545.1        464545.1
#> 3 nimble_slice       542978.3        542978.3
```
...
#>     samples: 9.31211630991968 8.25493170955207 3.28595295951126 5.754 ...
...
#>     metrics: list
#>     rename: function (newName, oldName) 
#>     samples: 6.31543155398573 6.31543155398573 5.74064065041648 4.526 ...
#>     sessionInfo: sessionInfo
#>     setSamples: function (samples) 
#>     times: list
#> 
...
#>     metrics: list
#>     rename: function (newName, oldName) 
#>     samples: 8.03121474423958 9.69438666143967 7.92048408641992 1.624 ...
#>     sessionInfo: sessionInfo
#>     setSamples: function (samples) 
#>     times: list
clearMetrics(res)
...
#> $byParameter
#>           MCMC Parameter     mean   median       sd CI95_low CI95_upp       ESS
#> 1         jags         a 5.016812 4.844788 1.975016 1.636743 9.446858  981.5543
#> 2       nimble         a 5.026045 4.835894 1.954984 1.676182 9.348682  402.2569
#> 3 nimble_slice         a 4.969071 4.846824 2.009493 1.537803 9.349607 1900.0000
#>   efficiency
#> 1   98155.43
#> 2  402256.90
#> 3  475000.00
...
#> $byMCMC
#>           MCMC min_efficiency mean_efficiency
#> 1         jags       98155.43        98155.43
#> 2       nimble      402256.90       402256.90
#> 3 nimble_slice      475000.00       475000.00
```
...
#> jags          3e-03     0.00700          0.010
#> nimble        5e-05     0.00095          0.001
#> nimble_slice  2e-04     0.00380          0.004
```
